...
export default async function handler(req: any, res: any): Promise<void> {
  ...
  try {
    ...
    const userPromise = (membersUrl && membersKey)
      ? withTimeout(
          fetch(`${membersUrl}/api/criar-usuario`, {
            ...
            body: JSON.stringify({ email, nome, whatsapp, route: 'semanadodespertar-40' }),
          }).then((r) => r.json()),
          4000,
          'criar-usuario'
        )
    ...
    const campanhasPM = '9b0e7e6d-c9cb-4756-8cd3-b824ab17517e';
    const campanhasIG = '022f1459-6828-4fb2-8a2d-67c504137346';
    ...
    const boasVindasPromise = withTimeout(
      fetch(`${crmUrl}/functions/v1/boas-vindas-enviar`, {
        ...
        body: JSON.stringify({ funnel_name: 'Turma #40', nome, email, whatsapp }),
      }),
      4000,
      'boas-vindas'
    );
